...
function groupFiles(files) {
  const definitions = [
    ...
    ["DevKit API and workspace experience", /^(?:apps\/devkit\/api\/|packages\/coworker-chat\/)/u],
    ["Platform identity and access", /^(?:apps\/platform\/(?:api|web)\/)/u],
    ["Container setup and deployment", /^\.container\//u],
