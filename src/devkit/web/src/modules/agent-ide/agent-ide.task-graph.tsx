...
function starterTasks(run: AgentRunDetail) {
  return [
    ...
    { agentProfile: "backend", dependsOn: ["inspect"], key: "backend", objective: "Implement the module-owned API and persistence slice.", scopePaths: ["src/devkit/api/"], title: "Build backend slice" },
    { agentProfile: "frontend", dependsOn: ["inspect"], key: "frontend", objective: "Implement the Project Agent visual workflow.", scopePaths: ["src/devkit/web/"], title: "Build frontend slice" },
