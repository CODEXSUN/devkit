...
export class ProjectManagerRepository {
  ...
  async create(record: ProjectManagerRecord, actorEmail: string) {
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .insertInto("devkit_project_manager_items")
  ...
  async listAttachments(
    ...
    const rows = await this.database
      .selectFrom("devkit_project_manager_attachments")
      .selectAll()
  ...
  async createAttachment(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .insertInto("devkit_project_manager_attachments")
        .values({
  ...
  async deleteAttachment(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .updateTable("devkit_project_manager_attachments")
        .set({
          sync_direction: "outbound",
          sync_status: "deleted",
          sync_updated_at: new Date(),
  ...
  async listRegistryPlatforms() {
    const rows = await this.database
      .selectFrom("devkit_project_manager_registry_platforms")
      .selectAll()
      .orderBy("sort_order")
  ...
  async createRegistryPlatform(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .insertInto("devkit_project_manager_registry_platforms")
  ...
  async updateRegistryPlatform(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .updateTable("devkit_project_manager_registry_platforms")
        .set({
          active: record.active ? 1 : 0,
          description: record.description,
          name: record.name,
  ...
  async listRegistryGroups() {
    const rows = await this.database
      .selectFrom("devkit_project_manager_registry_groups")
      .selectAll()
      .orderBy("sort_order")
      .orderBy("updated_at", "desc")
      .execute();
  ...
  async createRegistryGroup(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .insertInto("devkit_project_manager_registry_groups")
  ...
  async updateRegistryGroup(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .updateTable("devkit_project_manager_registry_groups")
        .set({
          active: record.active ? 1 : 0,
          description: record.description,
  ...
  async listRegistryModules() {
    const rows = await this.database
      .selectFrom("devkit_project_manager_registry_modules")
      .selectAll()
      .orderBy("sort_order")
      .orderBy("updated_at", "desc")
      .execute();
  ...
  async createRegistryModule(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .insertInto("devkit_project_manager_registry_modules")
  ...
  async updateRegistryModule(
    ...
    await this.database.transaction().execute(async (transaction) => {
      await transaction
        .updateTable("devkit_project_manager_registry_modules")
        .set({
          active: record.active ? 1 : 0,
          description: record.description,
...
async function writeActivity(
  ...
  await database
    .insertInto("devkit_project_manager_activity")
    .values({
      action: input.action,
