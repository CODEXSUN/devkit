...
| Web UI | Use React, Tailwind CSS, Radix UI, and shared UI components. | Current | DevKit web |
...
| Jobs | Use MariaDB as the source of truth. Use BullMQ and Redis as delivery adapters. | Current | DevKit API |
