---
name: devkit-release-log
description: Prepare a DevKit changelog and version-evidence job without committing, publishing, or deploying. Use when a project needs release notes or version verification.
---
