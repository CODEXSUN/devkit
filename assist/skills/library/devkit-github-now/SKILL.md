---
name: devkit-github-now
description: Prepare or perform an explicitly authorized DevKit commit, pull, and push through the repository GitHub helper. Use for repository synchronization, not release publishing or VPS deployment.
---
