...
1. Lock the watcher and require a clean `/home/devkit` `main` checkout.
...
8. Remove only stopped DevKit Compose one-off containers and unused images in the configured
