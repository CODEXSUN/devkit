...
const TOKEN_KEY = "devkit_session";
const SESSION_EXPIRED_WARNING_KEY = "devkit_session_expired_warning";
...
async function request<T>(path: string, options: RequestInit = {}): Promise<T> {
  ...
  if (!envelope) throw new Error("DevKit API returned an empty response.");
