    ...
    <div>
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          Trace the selected initiative through its linked tasks, activities, and
          reviews.
        </p>
      </div>
      <WorkspaceTablePanel>
      ...
      <table className="w-full min-w-[1180px] table-fixed text-sm">
        <thead>
          <tr>
            ...
            <WorkspaceTableHeaderCell>
              {dayCount}-day initiative schedule
            </WorkspaceTableHeaderCell>
          </tr>
        </thead>
        <tbody>
