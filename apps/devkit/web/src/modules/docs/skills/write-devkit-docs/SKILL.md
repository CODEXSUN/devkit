---
name: write-devkit-docs
description: Write, edit, review, or add DevKit documentation pages, MDX content, documentation SVGs, sidebar entries, and page navigation under apps/devkit/web/src/modules/docs. Use for every change to the DevKit Documentation workspace.
---
...
Run the Docs formatting check, DevKit web typecheck, DevKit web lint, and platform web production build. Report only checks that ran.
