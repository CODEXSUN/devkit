...
const destinations = [
  { icon: ClipboardCheckIcon, title: "My Work", url: "/app/devkit/my-work" },
  { icon: FolderKanbanIcon, title: "Projects", url: "/app/devkit/projects" },
  { icon: ListChecksIcon, title: "Tasks", url: "/app/devkit/tasks" },
  { icon: CircleDotIcon, title: "Issues", url: "/app/devkit/issues" },
  { icon: MapIcon, title: "Roadmap", url: "/app/devkit/roadmap" },
  { icon: CalendarRangeIcon, title: "Sprints", url: "/app/devkit/sprints" },
  { icon: GitPullRequestArrowIcon, title: "Releases", url: "/app/devkit/releases" }
] as const;
...
export function WorkOverviewWorkspace() {
  ...
  const summaries = [
    summary("My Work", activeTodos.length, dueContext(activeTodos), "/app/devkit/my-work"),
    summary("Projects", activeProjects.length, "active projects", "/app/devkit/projects"),
    summary("Tasks", activeTodos.length, statusContext(activeTodos), "/app/devkit/tasks"),
    summary("Issues", activeIssues.length, priorityContext(activeIssues), "/app/devkit/issues"),
    summary("Roadmap", activeIssues.length, "initiatives being planned", "/app/devkit/roadmap"),
    summary("Sprints", activeSprints.length, sprintContext(activeSprints), "/app/devkit/sprints"),
    summary(
      "Releases",
      ...
      <main className="mx-auto w-full max-w-7xl px-5 py-8 lg:px-8">
        <header className="border-b pb-7">
          ...
          <p className="max-w-2xl pt-2 text-base leading-7 text-muted-foreground">
            Live projects, tasks, initiatives, and releases from the DevKit workspace.
          </p>
